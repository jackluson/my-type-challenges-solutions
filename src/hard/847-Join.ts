...
type JoinString<T, U extends string | number> = T extends [infer F, ...infer REST] ? REST['length'] extends 0 ? F : F extends string | number ? `${F}${U}${JoinString<REST,U>}` : F : ''


declare function join<D extends string> (delimiter: D): <S extends string[]>(...parts: S) => JoinString<S,D>
