...
type UnionCombination<S extends string, O extends string = S> = S extends string
  ? Combination1<S, UnionCombination<Exclude<O, S>>>
  : never;

type Combination<T extends string[]> = UnionCombination<TupleToUnion<T>>


/* _____________ Test Cases _____________ */
import type { Equal, Expect } from '@type-challenges/utils'
type Res = Combination<['foo', 'bar', 'baz']>
type cases = [
