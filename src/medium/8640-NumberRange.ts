...
type NumberRange<L, H, R = L | H, Arr extends unknown[] = []> = Arr['length'] extends L ?
  Arr['length'] extends H ?
  R
  : NumberRange<[...Arr, unknown]['length'], H, R | Arr['length'], [...Arr, unknown]>
  : NumberRange<L, H, R, [...Arr, unknown]>
