...
import StringtoNumber from '../hard/300-StringtoNumber';
...
//         N,
//         {
//           readonly [K in A | keyof O as K extends string
//             ? Capitalize<K>
//             : never]: K extends A
//             ? N extends false
//               ? A
...
type Res = Enum<typeof OperatingSystem, false>;
