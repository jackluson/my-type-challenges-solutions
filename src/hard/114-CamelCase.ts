...
type CamelCaseIgnore<S extends string> = S extends `${infer A}_${infer R}`
  ? `${A}${CamelCaseIgnore<Capitalize<R>>}`
  : S;

type CamelCase<S extends string> = CamelCaseIgnore<Lowercase<S>>;
